<template>
  <footer class="bg-primary text-white py-12" id="contact">
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul class="space-y-2">
            ...
            <li><a href="#services" class="text-white hover:text-white">Services</a></li>
...
<script setup>
// No JavaScript needed for this simple footer
</script>
